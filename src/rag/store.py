...
class LazyVectorStore:
    ...
    def _init_db(self):
        ...
        logger.info(" Initializing Vector Store (ChromaDB + SentenceTransformers)...")
        ...
        try:
            ...
            raise ImportError(
                "RAG requires 'chromadb' and 'sentence-transformers'. Run `uv add chromadb sentence-transformers`."
            )
    ...
    def add_documents(self, documents: list[str], metadatas: list[dict], ids: list[str]):
        ...
        logger.info(f" Updating/Adding {len(documents)} chunks to DB...")
