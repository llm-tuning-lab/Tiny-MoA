...
class ToolCaller:
    ...
    def _load_falcon(self):
        ...
        logger.info(f" Loading Falcon-90M from: {model_path}")
        ...
        logger.info(" Loaded! (90M params, Q8_0)")
...
if __name__ == "__main__":
    print("=== Tool Caller 테스트 ===")  # noqa
    print("(Falcon-90M 모델 필요)")  # noqa
    ...
    print("\n키워드 기반 Tool 필요 여부:")  # noqa
    for inp in test_inputs:
        needs = caller.needs_tool(inp)
        print(f"  '{inp}' → Tool 필요: {needs}")  # noqa
